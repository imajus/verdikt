...
const brand = (go) => html`<a class="nav-brand" href=${LANDING_PATH} aria-label="Verdikt home" @click=${navigateOnClick(go, LANDING_PATH)}><img class="brand-mark" src="/favicon.svg" alt="" width="28" height="28" /><span>Verdikt</span></a>`;
