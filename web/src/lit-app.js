...
const how = () => html`
  ...
  <section class="block"><h3>The verdict is final — and that is not the whole question</h3><p>There is no challenge process and no arbiter. The refund cap keeps a false FAIL from being worth manufacturing, the observed value never goes on-chain, and the clause and the refund stay public on Arc.</p><p>But a verdict is a deterministic function, and that bounds what it can say. It knows the response parsed, arrived in time and was priced as advertised. It cannot know the summary summarised the wrong document.</p></section>
